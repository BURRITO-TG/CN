...
while True:
    ...
    if 'Cookie: user_id=User123' in request_data:
        ...
        # If no cookie, it's a new visitor. Give them one.
        print("❓ No cookie found. This is a new visitor. Setting cookie...")
        # The 'Set-Cookie' header tells the browser to store this cookie
