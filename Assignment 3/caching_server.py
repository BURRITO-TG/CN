...
# Start the server
HOST_IP="10.233.138.171"
with socketserver.TCPServer((HOST_IP, PORT), CachingRequestHandler) as httpd:
    print(f"Serving at port {PORT}. Open http://{HOST_IP}:{PORT} in your browser.")
